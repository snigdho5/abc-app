            ...
            <form method="post" id="emailMatrixRegister" action="{{route('emailmatrix.register')}} " enctype="multipart/form-data" > 
                ...
                <div class="row mt-4 onerow">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control config-val pname" autocomplete="off" id="em_per1" name="em_per[]" placeholder="Contact Person" value="{{$centreData['centre']}}"  readonly>
                        @else
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if (Auth::guard('admin')->user()->admin_role == 2) 
                        <input type="text" class="form-control config-val " autocomplete="off" id="em_email1"  name="em_email[]" placeholder="Contact Email" value="{{$centreData['centre_email']}}"  readonly>
                        @else
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        @if (Auth::guard('admin')->user()->admin_role == 2) 
                        <input type="text" class="form-control config-val " autocomplete="off" id="em_phone1" name="em_phone[]" maxlength="10" placeholder="Contact Phone" value="{{$centreData['centre_mobile']}}"  readonly>
                        @else
