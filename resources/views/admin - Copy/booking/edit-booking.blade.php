            ...
            <form method="post" id="bookingEdit" action="{{route('booking.edit')}} " enctype="multipart/form-data" > 
                ...
                <div class="row mt-4">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" autocomplete="off" id="book_time_from" name="book_time_from"   value="{{$bookingData['book_time_from']}}" readonly >
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="status">Time Out</label>
                        <input type="text" class="form-control" autocomplete="off" id="book_time_to" name="book_time_to"   value="{{$bookingData['book_time_to']}}" readonly >
                    </div>
                </div>
...
<!--                            <td class=" ">{{$value->book_time_from}}</td>
                            ...
                            <td class=" ">INR {{number_format($value->service_tot_amnt,2)}}</td>
                        </tr>
                        @endforeach
                        <?php
                        $tax_val = 0;
        ...
        <table id="datatable1" class="table table-striped ">
            ...
            <tbody>
                ...
                <tr class="pointer">
                    <td>{{number_format($value->payment_amnt,2)}}</td>
