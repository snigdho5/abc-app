    ...
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newSerRequestForm">
            ...
            <form method="post" id="serviceReqRegister" action="" enctype="multipart/form-data"> 
                ...
                <input type="hidden" name="centre_id" id="centre_id" value="{{$centreDetail[0]['centre_id']}}">
                <input type="hidden" name="loc_id" id="loc_id" value="{{getCentreLocation($centreDetail[0]['centre_id'])}}">
                ...
                <div class="row mt-4 d-flex">
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" class="form-control "  autocomplete="off"  id="customerser1" name="customerser1" value="{{$centreDetail[0]['centre']}}" disabled>
                        <div id="custList"></div>
					...
					<div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control "  autocomplete="off"  id="customerser2" name="customerser2" value="{{$ms_name}}" disabled>
                        <div id="custList"></div>
