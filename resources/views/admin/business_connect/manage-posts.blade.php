                ...
                <div class="table-responsive-md collRquest pb-4">
                    ...
                    <table id="datatable" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                <td class="whiteSpace">{{$value->post_content}}</td>
                                <td class="whiteSpace">{{$value->user_name}}</td>
                                <td class="whiteSpace">{{$value->user_mobile}}</td>
                                <td class="whiteSpace">{{$value->user_email}}</td>
                                <td class="whiteSpace">{{$value->published_date}}</td>
