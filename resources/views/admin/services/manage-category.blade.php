                    ...
                    <table id="datatable" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                ...
                                <td>{{$value->acat_type}}</td>
                                <td>@if($value->acat_status ==1) Enable @else Disable @endif</td>
                                <td class="last">
                                    <a href="javascript:void(0);" title="Edit" class="mr-4 ml-2 d-inline-block btn btn-secondary btnp text-uppercase editCategory" data-id="{{base64_encode($value->acat_id)}}">View</a> 
                                   <!-- <a href="{{route('category.delete',base64_encode($value->acat_id))}}"  title="Delete" class="d-inline-block delete confirmation"><img src="{{ URL::asset('images/delete.svg') }}" alt=""></a>-->
                                </td>
                            </tr>
                            @endforeach
            ...
            <form method="post" id="categoryRegister" action="{{route('category.register')}} " enctype="multipart/form-data"> 
                ...
                <!--<div class="row mt-4">
                    <div class="col-md-4 mb-3 padRig">
                        ...
                        @if ($errors->has('acat_name'))
                        <span class="help-block">
                            <strong>{{ $errors->first('acat_name') }}</strong>
                        </span>
                        @endif
                    ...
                    <div class="col-md-4 mb-3 padRig">
                        ...
                        @if ($errors->has('acat_intro'))
                        <span class="help-block">
                            <strong>{{ $errors->first('acat_intro') }}</strong>
                        </span>
                        @endif
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if ($errors->has('acat_type'))
                        <span class="help-block">
                            <strong>{{ $errors->first('acat_type') }}</strong>
                        </span>
                        @endif
				...
				<div class="row mt-4">
						...
						<div class="col-md-12 mb-3 padRig">
							...
							@if ($errors->has('acat_detail'))
							<span class="help-block">
								<strong>{{ $errors->first('acat_detail') }}</strong>
							</span>
							@endif
                ...
                <!--<div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if ($errors->has('acat_img'))
                        <span class="help-block">
                            <strong>{{ $errors->first('acat_img') }}</strong>
                        </span>
                        @endif
                    ...
                    <div class="col-md-3 mb-3 padRig">
                        ...
                        @if ($errors->has('acat_per_type'))
                        <span class="help-block">
                            <strong>{{ $errors->first('acat_per_type') }}</strong>
                        </span>
                        @endif
                    ...
                    <div class="col-md-3 mb-3 padRig">
                        ...
                        @if ($errors->has('acat_addons'))
                        <span class="help-block">
                            <strong>{{ $errors->first('acat_addons') }}</strong>
                        </span>
                        @endif
                    ...
                    <div class="col-md-3 mb-3 padRig">
                        ...
                        @if ($errors->has('acat_status'))
                        <span class="help-block">
                            <strong>{{ $errors->first('acat_status') }}</strong>
                        </span>
                        @endif
