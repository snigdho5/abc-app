                ...
                <div class="table-responsive-md collRquest pb-4">
                    <table id="datatable" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                <td>{{$value->n_id}}</td>
                                <td class="whiteSpace">{{$value->n_title}}</td>
                                <td class="whiteSpace">{{$value->n_url}}</td>
                                <td><img src="<?php if ($_SERVER['HTTP_HOST'] == 'localhost') {
    echo env('LOCAL_IMAGE_PATH');
} else {
    echo env('LIVE_IMAGE_PATH');
} ?>upload/news/{{$value->n_img}}" style="height: 50px;width:50px;"></td> 
                                <td>{{$value->n_ordering}}</td>
                                <td>@if($value->n_status ==1) Enable @else Disable @endif</td>
                                <td class="last">
                                    <a href="javascript:void(0);" title="Edit" class="mr-4 ml-2 d-inline-block"><img data-id="{{base64_encode($value->n_id)}}" class="editNews" src="{{ URL::asset('images/edit.svg') }}" alt=""></a> 
                                    <a href="{{route('news.delete',base64_encode($value->n_id))}}"  title="Delete" class="d-inline-block delete confirmation"><img src="{{ URL::asset('images/delete.svg') }}" alt=""></a>
                                </td>
                            </tr>
                            @endforeach
...
<div class="row pt-3">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newRequestForm">
            ...
            <form method="post" id="newsRegister" action="{{route('news.register')}} " enctype="multipart/form-data" > 
                {{ csrf_field() }}
                ...
                <div class="row mt-4">
                    <div class="col-md-12 mb-3 padRig">
                        ...
                        <span class="help-block">
                            <strong>{{ $errors->first('n_title') }}</strong>
                        </span>
                        @endif
                ...
                <div class="row mt-4">
                    <div class="col-md-12 mb-3 padRig">
                        ...
                        @if ($errors->has('n_heading'))
                        <span class="help-block">
                            <strong>{{ $errors->first('n_heading') }}</strong>
                        </span>
                        @endif
                ...
                <div class="row mt-4">
                    <div class="col-md-12 mb-3 padRig">
                        ...
                        @if ($errors->has('n_url'))
                        <span class="help-block">
                            <strong>{{ $errors->first('n_url') }}</strong>
                        </span>
                        @endif
                ...
                <div class="row mt-4">
                    <div class="col-md-4 mb-3 padRig">
                        ...
                        @if ($errors->has('n_img'))
                        <span class="help-block">
                            <strong>{{ $errors->first('n_img') }}</strong>
                        </span>
                        @endif
...
<?php $locnm = getLocationName($value->location); ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3 ">
                        ...
                        @if ($errors->has('n_ordering'))
                        <span class="help-block">
                            <strong>{{ $errors->first('n_ordering') }}</strong>
                        </span>
                        @endif
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        @if ($errors->has('n_status'))
                        <span class="help-block">
                            <strong>{{ $errors->first('n_status') }}</strong>
                        </span>
                        @endif
