                   ...
                   var url = GlblURLs + "admin/filter-request";
                    $.ajax({
                        ...
                        success: function (data) {
                            $('.this-month-text').css('display','none');
                            $('.cancel-req-cnt').text(data.cancelReqCnt);
                            //$('.cancel-req-cnt-bar').data('transitiongoal').val(data.cancelReqCnt);
                            $('.cancel-req-cnt-bar').attr('data-transitiongoal',data.cancelReqCnt);
                            $('.cancel-req-cnt-bar').attr('aria-valuenow',data.cancelReqCnt);
                            $('.cancel-req-cnt-bar').css('width',data.cancelReqCnt+'%');
                            $('.closed-req-cnt').text(data.closedReqCnt);
                            $('.closed-req-cnt-bar').attr('data-transitiongoal',data.closedReqCnt);
                            $('.closed-req-cnt-bar').attr('aria-valuenow',data.closedReqCnt);
                            $('.closed-req-cnt-bar').css('width',data.closedReqCnt+'%');
                            //divProgressBar.Attributes.Add("data-transitiongoal", "100");
