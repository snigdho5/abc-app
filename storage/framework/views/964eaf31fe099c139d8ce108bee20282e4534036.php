                ...
                <div class="table-responsive-md collRquest pb-4">
                    ...
                    <table id="datatable" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                <td class="whiteSpace"><?php echo e($value->post_content); ?></td>
                                <td class="whiteSpace"><?php echo e($value->user_name); ?></td>
                                <td class="whiteSpace"><?php echo e($value->user_mobile); ?></td>
                                <td class="whiteSpace"><?php echo e($value->user_email); ?></td>
                                <td class="whiteSpace"><?php echo e($value->published_date); ?></td>
