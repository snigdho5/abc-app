        ...
        <div class="x_panel newRequestForm">
            ...
            <form method="post" id="emailMatrixRegister" action="<?php echo e(route('emailmatrix.register')); ?> " enctype="multipart/form-data" > 
                ...
                <?php } else { ?>
                    ...
                    <input type="hidden" name="centre_id" value="<?php echo Auth::guard('admin')->user()->center_id ?>">	     
                <?php } ?>
                ...
                <div class="row mt-4 onerow">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control config-val pname" autocomplete="off" id="em_per1" name="em_per[]" placeholder="Contact Person" value="<?php echo e($centreData['centre']); ?>"  readonly>
                        <?php else: ?>

                        <input type="text" class="form-control config-val pname" autocomplete="off" id="em_per1" name="em_per[]" placeholder="Contact Person" value=""  readonly>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <?php if(Auth::guard('admin')->user()->admin_role == 2): ?> 
                        <input type="text" class="form-control config-val " autocomplete="off" id="em_email1"  name="em_email[]" placeholder="Contact Email" value="<?php echo e($centreData['centre_email']); ?>"  readonly>
                        <?php else: ?>
                        <input type="text" class="form-control config-val " autocomplete="off" id="em_email1" name="em_email[]" placeholder="Contact Email" value="" readonly>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <?php if(Auth::guard('admin')->user()->admin_role == 2): ?> 
                        <input type="text" class="form-control config-val " autocomplete="off" id="em_phone1" name="em_phone[]" maxlength="10" placeholder="Contact Phone" value="<?php echo e($centreData['centre_mobile']); ?>"  readonly>
                        <?php else: ?>
                        <input type="text" class="form-control config-val onlyNum" autocomplete="off" id="em_phone1" name="em_phone[]" maxlength="10" placeholder="Contact Phone" value="" readonly>
                        <?php endif; ?>
                    </div>
