                ...
                <div class="table-responsive-md collRquest pb-4">
                    <table id="datatable" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                <td class="whiteSpace"><?php echo e(strip_tags($value->intro_text)); ?></td>
                                <td><img src="<?php if ($_SERVER['HTTP_HOST'] == 'localhost') {
    echo env('LOCAL_IMAGE_PATH');
} else {
    echo env('LIVE_IMAGE_PATH');
} ?>upload/intro/<?php echo e($value->intro_image); ?>" style="height: 50px;width:50px;"></td> 
                                <td class="whiteSpace"><?php echo e($value->intro_url); ?></td>
                                <td><?php if($value->intro_status ==1): ?> Enable <?php else: ?> Disable <?php endif; ?></td>
                                <td class="last">
                                    <a href="javascript:void(0);" title="Edit" class="mr-4 ml-2 d-inline-block btn btn-secondary btnp text-uppercase editIntro" data-id="<?php echo e(base64_encode($value->intro_id)); ?>">View</a> 
                                    <a href="<?php echo e(route('introdata.delete',base64_encode($value->intro_id))); ?>"  title="Delete" class="d-inline-block delete confirmation"><img src="<?php echo e(URL::asset('images/delete.svg')); ?>" alt=""></a>
                                </td>
                            </tr>
...
<div class="row pt-3">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newRequestForm">
            ...
            <form method="post" id="introRegister" action="<?php echo e(route('introdata.register')); ?> " enctype="multipart/form-data" > 
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <?php if($errors->has('intro_image')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('intro_image')); ?></strong>
                        </span>
                        <?php endif; ?>
                ...
                <div class="row mt-4">
                    <div class="col-md-12 mb-3">
                        ...
                        <?php if($errors->has('intro_url')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('intro_url')); ?></strong>
                        </span>
                        <?php endif; ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <?php if($errors->has('intro_status')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('intro_status')); ?></strong>
                        </span>
                        <?php endif; ?>
