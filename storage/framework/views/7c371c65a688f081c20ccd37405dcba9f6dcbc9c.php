            ...
            <form method="post" id="bookingEdit" action="<?php echo e(route('booking.edit')); ?> " enctype="multipart/form-data" > 
                ...
                <div class="row mt-4">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" autocomplete="off" id="book_time_from" name="book_time_from"   value="<?php echo e($bookingData['book_time_from']); ?>" readonly >
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="status">Time Out</label>
                        <input type="text" class="form-control" autocomplete="off" id="book_time_to" name="book_time_to"   value="<?php echo e($bookingData['book_time_to']); ?>" readonly >
                    </div>
                </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <?php } else { ?>
                            <select  class="form-control select"   id="book_status" name="book_status">
                                ...
                                <option value="1" <?php if ($bookingData['book_status'] == 1) echo "selected"; ?>>Pending</option>
                                <option value="2" <?php if ($bookingData['book_status'] == 2) echo "selected"; ?>>Confirm</option>
                                <option value="3" <?php if ($bookingData['book_status'] == 3) echo "selected"; ?> >Pay at Centre</option>
                                <option value="4" <?php if ($bookingData['book_status'] == 4) echo "selected"; ?> >Cancel</option>
                                <option value="5" <?php if ($bookingData['book_status'] == 5) echo "selected"; ?> >Close</option>
                            </select>
                        <?php } ?>
                    </div>
...
<!--                            <th class="column-title">Time From</th>
                    ...
                    <tbody>
                        ...
                        <?php $service_tot_amnt = $service_tot_amnt + $value->service_tot_amnt; ?>
                        <tr class="pointer">
...
<!--                            <td class=" "><?php echo e($value->book_time_from); ?></td>
                            ...
                            <td class=" ">INR <?php echo e(number_format($value->service_tot_amnt,2)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        $tax_val = 0;
        ...
        <table id="datatable1" class="table table-striped ">
            ...
            <tbody>
                ...
                <tr class="pointer">
                    <td><?php echo e(number_format($value->payment_amnt,2)); ?></td>
