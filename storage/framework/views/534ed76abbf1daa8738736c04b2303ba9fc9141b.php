        ...
        <ul class="nav side-menu">
            ...
            <li class="nav-item"><a class="nav-link"><span>Manage Managers</span></a>
                <ul class="nav child_menu">
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('manager.manage-manager')); ?>" class="nav-link">Manage Managers</a> </li>
                </ul>
            </li>
            <?php endif; ?>
            <li class="nav-item"><a class="nav-link"><span>Manage Corporate <br/>Client</span></a>
                <ul class="nav child_menu">
                    <li class="nav-item"><a href="<?php echo e(route('companyclient.manage')); ?>" class="nav-link">Manage Company</a> </li>
...
<!--                    <li class="nav-item"><a href="<?php echo e(route('discount.manage')); ?>" class="nav-link">Manage Discount</a> </li>-->
					...
					<?php if(Auth::guard('admin')->user()->admin_role==1): ?> 
                    <li class="nav-item"><a href="<?php echo e(route('clientbenefits.manage')); ?>" class="nav-link">Manage Client Benefits</a> </li>
					<?php endif; ?>
                </ul>
            </li>
            <?php if(Auth::guard('admin')->user()->admin_role==1): ?> 
 ...
 <li class="nav-item"><a href="<?php echo e(route('category.manage')); ?>" class="nav-link">Manage Service Category</a> </li>
            ...
            <li class="nav-item"><a  class="nav-link"><span>Manage Notifications</span></a>
                <ul class="nav child_menu">
                    <li class="nav-item"><a href="<?php echo e(route('notification.manage')); ?>" class="nav-link">Send Messages</a> </li>
                </ul>
            </li> 
            <?php endif; ?>
            <?php endif; ?>
