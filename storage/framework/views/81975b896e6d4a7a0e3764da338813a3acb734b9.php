                ...
                <div class="col-lg-3 col-md-3 col-12 bg-white pt-5">
                    ...
                    <div class="col-lg-12 col-md-12 col-12 mb-2 mb-xl-0">
                        <div class="col pl-0 pr-0 pt-3">
                            <p class="mb-2 size-12">Approved  - <strong class="text-success float-right closed-req-cnt"><?php echo e($custData['appr_cust_count6']); ?></strong></p>

                            <div class="progress progress_sm">
                                <div class="progress-bar bg-success closed-req-cnt-bar" role="progressbar" data-transitiongoal="<?php echo e($custData['appr_cust_count6']); ?>"></div>
                            </div>

                        </div>
                        <div class="col pl-0 pr-0 pt-3">
                            <p class="mb-2 size-12">Pending - <strong class="text-warning float-right cancel-req-cnt"><?php echo e($custData['pend_cust_count6']); ?></strong></p>

                            <div class="progress progress_sm">
                                <div class="progress-bar bg-warning cancel-req-cnt-bar" role="progressbar" data-transitiongoal="<?php echo e($custData['pend_cust_count6']); ?>"></div>
