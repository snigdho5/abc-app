            ...
            <form method="post" id="eventRegister" action="<?php echo e(route('event.register')); ?> " enctype="multipart/form-data" > 
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3 padRig">
                        ...
                        <div  class="position-relative">
                            <span class="input-group-btn d-flex ">
                                <input id="customFile" type="file" multiple class=" d-none" name="e_gallery[]" onchange="$(this).parent().parent().find('.form-control').html($(this).val().split(/[\\|/]/).pop());" style="display: none;">
                            </span>
