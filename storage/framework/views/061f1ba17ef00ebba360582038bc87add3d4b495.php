...
<div class="row pt-3">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newSerRequestForm">
            ...
            <div class="x_title">
                <h2 id="titleText" >Create Booking Request </h2>
            ...
            <form method="post" id="serviceReqRegister" action="" enctype="multipart/form-data"> 
                ...
                <input type="hidden" name="ms_cat" id="ms_cat" value="<?php echo e($ms_cat); ?>">
                <input type="hidden" name="ms_id" id="ms_id" value="<?php echo e($ms_id); ?>">
                <input type="hidden" name="centre_id" id="centre_id" value="<?php echo e($centreDetail[0]['centre_id']); ?>">
                <input type="hidden" name="loc_id" id="loc_id" value="<?php echo e(getCentreLocation($centreDetail[0]['centre_id'])); ?>">
                ...
                <div class="row mt-4 d-flex">
                    <div class="col-md-8 mb-3">
                        <label for="selectLocation ">Selected Centre</label>
                        <input type="text" class="form-control "  autocomplete="off"  id="customerser1" name="customerser1" value="<?php echo e($centreDetail[0]['centre']); ?>" disabled>
                        <div id="custList"></div>

                    </div>
					<?php if($ms_cat == 5) { ?>
					<div class="col-md-4 mb-3">
                        <label for="selectLocation ">Selected Package</label>
                        <input type="text" class="form-control "  autocomplete="off"  id="customerser2" name="customerser2" value="<?php echo e($ms_name); ?>" disabled>
                        <div id="custList"></div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-12 mb-3 padRig">
                        ...
                        <input type="hidden" name="book_date_range" id="book_date_range" value="<?php echo e(app('request')->input('req_date_range')); ?>">
                        </select>
                    </div>
                </div>
                <?php else: ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3 padRig">
					<?php if($ms_cat == 5) { ?>
						<label for="requestEmailID">Start Date</label>
					<?php } else { ?>
                ...
                <?php if($addonhtml !='' && ($ms_cat == 3 || $ms_cat == 4 || $ms_cat == 1)): ?>
                <div class="row mt-4">
                    <div class="col-md-4 mb-3 padRig">
