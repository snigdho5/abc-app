...
<?php } ?>
                ...
                <?php $routeValues = 'search=' . app('request')->input('search').'&book_status='.app('request')->input('book_status').'&req_date_range='.app('request')->input('req_date_range'); ?>
                        <div class="col-12 text-right pl-0 pr-0 pb-3 clearfix"><a href="<?php echo e(route('booking.export',$routeValues)); ?>" class="btn btn-outline-secondary pl-4 pr-4 pt-2 pb-2  m-0" id="exporttoExcel"> <img src="<?php echo e(URL::asset('images/excel.svg')); ?>" class="pr-2" alt="Export to Excel"> Export to CSV </a></div>
