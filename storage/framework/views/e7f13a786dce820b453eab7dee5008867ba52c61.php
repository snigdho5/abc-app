                ...
                <?php if (count($notidata['notidata']) > 0) { ?>
                    <li role="presentation"  class="dropdown nav-item"> 
                        ...
                        <ul id="menu1" class="dropdown-menu list-unstyled msg_list"role="menu">
                            ...
                            <li class="dropdown-item"> <a href="<?php echo e(route('booking.data',base64_encode($value->booking_id))); ?>"><i class="fa fa-bell"></i> <span> <span>ABC</span> <span class="time"><?php echo e(get_time_difference_php($value->created_at)); ?></span> </span> <span class="message"><?php echo e(reduceWords($value->user_name.' has a service request')); ?> </span> </a> </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <li class="dropdown-item">
                                <div class="text-center"> <a href="<?php echo e(route('booking.manage')); ?>"> <strong>See All Bookings</strong> <i class="fa fa-angle-right"></i> </a> </div>
                            </li>
                        </ul>
                    </li>
                <?php } else { ?>
