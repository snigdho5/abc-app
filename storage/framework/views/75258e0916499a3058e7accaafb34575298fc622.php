...
<div class="row pt-3">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newSerRequestForm">
            ...
            <div class="x_title">
                <h2 id="titleText" >Create Booking Request <?php echo e($ms_name); ?></h2>
            ...
            <form method="post" id="serviceReqRegister" action="" enctype="multipart/form-data"> 
                ...
                <input type="hidden" name="centre_id" id="centre_id" value="<?php echo e(Auth::guard('admin')->user()->center_id); ?>">
                <input type="hidden" name="loc_id" id="loc_id" value="<?php echo e(getCentreLocation(Auth::guard('admin')->user()->center_id)); ?>">
