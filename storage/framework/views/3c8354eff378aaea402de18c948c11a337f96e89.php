                ...
                <div class="table-responsive-md collRquest pb-4">
                    <table id="datatable" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                <td class="whiteSpace"><?php echo e(getCentreName($value->vt_centre_id)); ?></td>
                                <td class="whiteSpace"><?php echo e(strip_tags($value->vt_title)); ?></td>
                                <td class="whiteSpace"><?php echo e(strip_tags($value->vt_subtitle)); ?></td>
                                <td class="whiteSpace"><?php echo e($value->vt_embed_map); ?></td>
                                <td><?php if($value->vt_status ==1): ?> Enable <?php else: ?> Disable <?php endif; ?></td>
                                <td class="last">
                                    <a href="javascript:void(0);" title="Edit" class="mr-4 ml-2 d-inline-block btn btn-secondary btnp text-uppercase editVtour" data-id="<?php echo e(base64_encode($value->vt_id)); ?>">View</a> 
                                    <a href="<?php echo e(route('virtualtour.delete',base64_encode($value->vt_id))); ?>"  title="Delete" class="d-inline-block delete confirmation"><img src="<?php echo e(URL::asset('images/delete.svg')); ?>" alt=""></a>
                                </td>
                            </tr>
...
<div class="row pt-3">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newRequestForm">
            ...
            <form method="post" id="vtourRegister" action="<?php echo e(route('virtualtour.register')); ?> " enctype="multipart/form-data" > 
...
<?php $locnm = getLocationName($value->location); ?>
                ...
                <div class="row mt-4">
                    <div class="col-md-12 mb-3">
                        ...
                        <?php if($errors->has('vt_title')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('vt_title')); ?></strong>
                        </span>
                        <?php endif; ?>
                ...
                <div class="row mt-4">
                    <div class="col-md-12 mb-3">
                        ...
                        <?php if($errors->has('vt_subtitle')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('vt_subtitle')); ?></strong>
                        </span>
                        <?php endif; ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <?php if($errors->has('vt_th_img')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('vt_th_img')); ?></strong>
                        </span>
                        <?php endif; ?>
                ...
                <div class="row mt-4">
                    <div class="col-md-12 mb-3">
                        ...
                        <?php if($errors->has('vt_embed_map')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('vt_embed_map')); ?></strong>
                        </span>
                        <?php endif; ?>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <?php if($errors->has('vt_status')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('vt_status')); ?></strong>
                        </span>
                        <?php endif; ?>
