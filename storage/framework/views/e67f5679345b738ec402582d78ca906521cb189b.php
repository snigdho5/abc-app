                    ...
                    <table id="datatable" class="table table-striped ">
                        ...
                        <tbody>
                            ...
                            <tr class="pointer">
                                ...
                                <td class="last">
                                    <a href="<?php echo e(route('applink.delete',base64_encode($value->id))); ?>"  title="Delete" class="d-inline-block delete confirmation"><img src="<?php echo e(URL::asset('images/delete.svg')); ?>" alt=""></a>
                                </td>
                            </tr>
...
<div class="row pt-3">
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newRequestForm">
            ...
            <form method="post" id="applinkRegister" action="<?php echo e(route('applink.register')); ?> " enctype="multipart/form-data"> 
