...
?>
                            ...
                            <tr class="pointer">
                                ...
                                <td class="whiteSpace"><?php echo e(implode(PHP_EOL, str_split($value->link, $break))); ?></td>
    ...
    <div class="col-lg-12 col-md-12 col-12">
        <div class="x_panel newRequestForm">
            ...
            <form method="post" id="applinkRegister" action="<?php echo e(route('centreloc.register')); ?> " enctype="multipart/form-data"> 
                ...
                <div class="row mt-4">
                    <?php if(Auth::guard('admin')->user()->admin_role == 1 || count($centreData) > 1): ?>
...
<?php $locnm = getLocationName($value->location); ?>
                    ...
                    <?php else: ?> 
                    <input type="hidden" name="centre_id" value="<?php echo e($centreData[0]['centre_id']); ?>" >
                    <?php endif; ?>
