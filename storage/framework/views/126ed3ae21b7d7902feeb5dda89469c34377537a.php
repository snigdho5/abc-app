    ...
    <div class="col-lg-12 col-md-12 col-12">
        <form method="post" id="centreRegister" action="<?php echo e(route('meetingroom.editmanager')); ?> " enctype="multipart/form-data" > 
            <div class="x_panel newRequestForm">
                ...
                <div class="row mt-4">
                    <div class="col-md-4 mb-3">
                        ...
                        <h6><?php echo e($locationData->loc_name); ?></h6>

                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="pageName">Centre</label>
                        <h6><?php echo e($cinfoData->centre); ?></h6>

                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="pageName">Address</label>
                        <h6><?php echo e($cinfoData->centre_address); ?></h6>
                    </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-4 mb-3">
                        ...
                        <h6><?php echo e($cinfoData->centre_email); ?></h6>

                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="pageName">Mobile</label>
                        <h6><?php echo e($cinfoData->centre_mobile); ?></h6>

                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="pageName">Phone</label>
                        <h6><?php echo e($cinfoData->centre_phone); ?></h6>  
                    </div>
            ...
            <div class="x_panel newRequestForm">
                ...
                <?php $__currentLoopData = $emaildata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="row mt-4">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control config-val" autocomplete="off" id="user_name" name="user_name" placeholder="User name" value="<?php echo e($value1->em_per); ?>" readonly >
                    </div>
                    <div class="col-md-4 mb-3">


                        <input type="text" class="form-control config-val" autocomplete="off" id="email" name="email" placeholder="Email" value="<?php echo e($value1->em_email); ?>" readonly >
                    </div>
                    <div class="col-md-3 mb-3">


                        <input type="text" class="form-control config-val" autocomplete="off" id="mobile" name="mobile" placeholder="Mobile" value="<?php echo e($value1->em_phone); ?>" readonly >
                    </div>
                    <div class="col-md-1  help-block d-block pt-2 align-self-center ">
                        <a href="<?php echo e(route('emailmatrix.delete',base64_encode($value1->em_id))); ?>"  title="Delete" class="d-inline-block delete confirmation"><img src="<?php echo e(URL::asset('images/delete.svg')); ?>" alt=""></a>
            ...
            <div class="x_panel newRequestForm">
                ...
                <div class="row mt-4">
                    ...
                    <div class="row  m-0 pb-3">
                        <div class="col-md-6 text-right  pr-0 pb-3 clearfix"><a href="<?php echo e(route('emailmatrix.manage')); ?>" class="btn btn-outline-secondary  pl-4 pr-4 pt-2 pb-2  m-0" id="addNewRequest"> Add/Edit Additional Info</a></div>
                        <div class="col-md-6 text-right  pr-0 pb-3 clearfix"><a href="<?php echo e(route('servicecategory.manage')); ?>" class="btn btn-outline-secondary  pl-4 pr-4 pt-2 pb-2  m-0" id="addNewRequest"> Manage Service Categories</a></div>
                    </div>    
                </div>
            </div>		     
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table  class="table table-striped table-responsive">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo e(route('meetingroom.delete',base64_encode($value1->rr_id))); ?>"  title="Delete" class="d-inline-block delete confirmation"><img src="<?php echo e(URL::asset('images/delete.svg')); ?>" alt=""></a>
                                                </td>
