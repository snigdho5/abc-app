            ...
            <form method="post" id="centreRegister" action="<?php echo e(route('centre.register')); ?> " enctype="multipart/form-data" > 
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <?php if($errors->has('centre_gallery')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('centre_gallery')); ?></strong>
                        </span>
                        <?php endif; ?>
                        <div  class="position-relative">
                            <span class="input-group-btn d-flex ">
                ...
                <div class="row mt-4">
                    <div class="col-md-4 mb-3">
                        <label for="pageName" class="d-block">Cafeteria Menu Image</label>
                        <?php if($errors->has('centre_menu')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('centre_menu')); ?></strong>
                        </span>
                        <?php endif; ?>
                        <div  class="position-relative">
                            <span class="input-group-btn d-flex ">
                                <input id="customFile2" type="file" class=" d-none centre_img_file" name="centre_menu" onchange="$(this).parent().parent().find('.form-control').html($(this).val().split(/[\\|/]/).pop());" style="display: none;">
                            </span>
                            <label for="customFile2" class=" form-control formFile custom-file-label rounded-pill" >Choose file</label>
